  ...
  return (
    <div className="h-full pb-20 md:pb-0">
      ...
      <div className="flex flex-col md:flex-row h-full min-h-[calc(100vh-4rem)]">
        {/* Sidebar */}
        <div className="w-full md:w-[280px] border-b md:border-b-0 md:border-r border-border p-4 space-y-3">
          <Skeleton className="h-3 w-24 mb-4" />
          {[...Array(4)].map((_, i) => (
            <div key={i} className="py-3 border-b border-border/60 space-y-1.5 last:border-0">
